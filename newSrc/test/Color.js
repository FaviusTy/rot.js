...
// interpolate
assert.deepEqual(
  Color.interpolate([10, 20, 40], [100, 200, 300], 0.1),
  [19, 38, 66],
  'should intepolate two colors'
)
assert.deepEqual(
  Color.interpolate([10, 20, 40], [15, 30, 53], 0.5),
  [13, 25, 47],
  'should round values',
)
assert.deepEqual(
  Color.interpolate([10, 20, 40], [20, 30, 40]),
  [15, 25, 40],
  'should default to 0.5 factor',
)

// interpolateHSL
assert.deepEqual(
  Color.interpolateHSL([10, 20, 40], [100, 200, 300], 0.1),
  [12, 33, 73],
  'should intepolate two colors',
)
